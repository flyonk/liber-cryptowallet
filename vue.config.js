...
module.exports = {
  ...
  css: {
    loaderOptions: {
      scss: {
        additionalData: `@import "@/assets/styles/common/liber/variables.scss"; @import "${process.env.VUE_APP_STATIC_BASE_URL}/styles/libs/iconmoon.css"; @import "${process.env.VUE_APP_STATIC_BASE_URL}/build/fonts/${whitelabelConfigPath.brand}/font.css";`,
      },
    },
  },
};
