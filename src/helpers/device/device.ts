...
function DeviceException(message: string, code: string) {
...
export class DeviceWeb implements DevicePlugin {
  ...
  async getInfo(): Promise<DeviceInfo> {
    if (typeof navigator === 'undefined' || !navigator.userAgent) {
      throw new (DeviceException as any)(
