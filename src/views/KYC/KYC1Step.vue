<template>
  <div>
    ...
    <p
      class="description"
    >The terms and services which apply to you, will depend on your country of residence</p>
    <base-country-select v-model="country" :only-european="true" @update:model-value="setCountry" />
    <div class="footer">
      <p class="heading-dark-gray-md font-weight--semibold text">
        ...
        <a class="link" href="http://">Privacy Policy</a>. Your data will be securely encrypted with TLS
      </p>
