  ...
  <div class="account-settings">
    ...
    <div class="controls">
      <button class="btn -blue">
        <img class="icon" src="@/assets/icon/user_heart.svg" /> {{ $t('views.profile.profileSettings.invite') }}
      </button>
      <button class="btn -white">{{ $t('views.profile.profileSettings.copy') }}</button>
    </div>
    <div class="main">
      <h6 class="subtitle">{{ $t('views.profile.profileSettings.profile') }}</h6>
      <ul class="list list--profile">
        ...
        <router-link to="/account" class="item">
          ...
          <p class="text">{{ $t('views.profile.profileSettings.allAccounts') }}</p>
        </router-link>
      ...
      <h6 class="subtitle">{{ $t('views.profile.profileSettings.security') }}</h6>
      <ul class="list security--profile">
        <router-link to="/passcode" class="item">
          <img class="icon" src="@/assets/icon/lock.svg" />
          <p class="text">{{ $t('views.profile.profileSettings.changePasscode') }}</p>
        </router-link>
        <li class="item">
        ...
        <li class="item">
          ...
          <p class="text">{{ $t('views.profile.profileSettings.2FAGoogle') }}</p>
        </li>
