...
export const CRYPTO_CURRENCIES_ENABLED =
  !!process.env.VUE_APP_CRYPTO_CURRENCIES_ENABLED;
export const FIAT_ENABLED = !!process.env.VUE_APP_FIAT_ENABLED;
export const MULTI_LANGUAGE = !!process.env.VUE_APP_MULTI_LANGUAGE;
export const TRANSACTIONS_ENABLED =
  !!process.env.VUE_APP_TRANSACTIONS_FOR_NOT_VERIFIED_USERS;
